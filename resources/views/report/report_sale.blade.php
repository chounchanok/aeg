...
@section('subhead')
    <title>รายงานยอดพนักงานขาย - AEG</title>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.13.2/themes/base/jquery-ui.min.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{ asset('dist/css/datatables.min.css') }}">
@endsection

@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">รายงานยอดพนักงานขาย</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">

        <form method="POST" action="{{ url('report_sale') }}" class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            @csrf
            ...
            <div class="dropdown col-span-1 sm:col-span-1 md:col-span-1 2xl:col-span-1">
                ...
                <div class="dropdown-menu w-40">
                    <ul class="dropdown-content">
                        <li>
                            <a href="#" class="dropdown-item" onclick="exportTableToExcel('reportTable', 'Employee Report {{ $datestart_show }} to {{$dateend_show }}')">
