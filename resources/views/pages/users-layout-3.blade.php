...
@section('subhead')
    <title>จัดการข้อมูลพนักงาน - AEG</title>
@endsection

@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">จัดการข้อมูลพนักงาน</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <button class="btn btn-primary shadow-md mr-2">เพิ่มพนักงานใหม่</button>
            <div class="dropdown">
            ...
            <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4">
                <div class="box">
                        ...
                        <div class="absolute right-0 top-0 mr-5 mt-3 dropdown">
                            ...
                            <div class="dropdown-menu w-40">
                                <div class="dropdown-content">
                                    <a href="" class="dropdown-item">
                                        <i data-lucide="edit-2" class="w-4 h-4 mr-2"></i> แก้ไข
                                    </a>
                                    <a href="" class="dropdown-item">
                                        <i data-lucide="trash" class="w-4 h-4 mr-2"></i> ลบ
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-center lg:text-right p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                        ...
                        <button class="btn btn-outline-secondary py-1 px-2">ดูข้อมูลพนักงาน</button>
                    </div>
                </div>
            </div>
        @endforeach
