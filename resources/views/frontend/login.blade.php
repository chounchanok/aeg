...
<body>
    ...
    <div class="login-card">
        ...
        <div class="social-icons-group row justify-content-center g-3">
            <!-- LINE -->
            <a href="{{ route('social.redirect', 'line') }}" class="social-login-btn text-decoration-none col-lg-3 col-sm-6" title="เข้าสู่ระบบด้วย LINE">
                <img src="https://upload.wikimedia.org/wikipedia/commons/4/41/LINE_logo.svg" alt="LINE Icon">
            </a>
            
            <!-- Google -->
            <a href="{{ route('social.redirect', 'google') }}" class="social-login-btn text-decoration-none col-lg-3 col-sm-6" title="เข้าสู่ระบบด้วย Google">
            ...
            <!-- Facebook -->
            <a href="{{ route('social.redirect', 'facebook') }}" class="social-login-btn text-decoration-none col-lg-3 col-sm-6" title="เข้าสู่ระบบด้วย Facebook">
            ...
            <button type="button" data-bs-toggle="modal" data-bs-target="#whatsappQrModal" onclick="initWhatsAppLogin()" class="social-login-btn text-decoration-none col-lg-3 col-sm-6" title="เข้าสู่ระบบด้วย WhatsApp">
